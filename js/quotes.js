// Borrowed from programthink - 编程随想
(function()
{
  m_mapMaxim =
  {
    arrDefault : [
      ...
      "那不能杀死我的, 使我更强!   What does not kill me, makes me stronger.   @尼采 (哲学家)",
      ...
      "如果有一天, 党宣布'2+2=5', 你也不得不相信它 :-(  @《1984》乔治.奥威尔",
      "艺术家用谎言揭露真相   政治家用谎言掩盖真相  Artists use lies to tell the truth, while politicians use them to cover the truth up.   @《V怪客&#65295;V字仇杀队》",
  ...
  function init()
  {
    var arrMaxim = m_mapMaxim.arrDefault.slice();
