---
title: 第36期 AI News Daily｜Quoting Chengpeng Mou
date: 2026-04-05
layout: brief-post
...
brief_data:
  ...
  items:
    - title: "Eight years of wanting, three months of building with AI"
      ...
      opinion: "原文重点：Lalit Maganti provides one of my favorite pieces of long-form writing on agentic engineering I've seen in ages. 读后观点：这篇内容真正有价值的部分是 They spent eight years thinking about and then three months building syntaqlite, … 5…"
    - title: "Quoting Chengpeng Mou"
      ...
      opinion: "原文重点：From anonymized U.S. 读后观点：这篇内容真正有价值的部分是 ChatGPT data, we are seeing: ~2M weekly messages on health insurance ~600K weekly messages [classified as healthcare] from people living in “hospital deserts” (30 min drive to…"
    - title: "Continual learning for AI agents"
      ...
      opinion: "原文重点：Most discussions of continual learning in AI focus on one thing: updating model weights. 读后观点：这篇内容真正有价值的部分是 But for AI agents, learning can happen at three distinct layers: the model, the harness, and the context."
    ...
    - title: "Quantifying infrastructure noise in agentic coding evals"
      ...
      opinion: "原文重点：Anthropic is an AI safety and research company that's working to build reliable, interpretable, and steerable AI systems. 读后观点：这篇内容真正有价值的部分是 Agentic coding benchmarks like SWE-bench and Terminal-Bench are commonly u…"
    - title: "Harness design for long-running application development"
      ...
      opinion: "原文重点：Anthropic is an AI safety and research company that's working to build reliable, interpretable, and steerable AI systems. 读后观点：这篇内容真正有价值的部分是 Written by Prithvi Rajasekaran, a member of our Labs team."
    - title: "scan-for-secrets 0.1"
      ...
      opinion: "原文重点：Scan for secrets in files you plan to share 5th April 2026 I like publishing transcripts of local Claude Code sessions using my claude-code-transcripts tool but I'm often paranoid that one of my API keys or similar…"
    ...
    - title: "2025 LLM Year in Review"
      ...
      opinion: "原文重点：2025 Year in Review of LLM paradigm changes 2025 Year in Review of LLM paradigm changes 2025 LLM Year in Review 19 Dec, 2025 2025 has been a strong and eventful year of progress in LLMs. 读后观点：这篇内容真正有价值的部分是 The follo…"
---
