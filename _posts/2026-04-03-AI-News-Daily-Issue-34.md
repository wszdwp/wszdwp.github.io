---
title: "第34期 | Quantifying infrastructure noise in agentic coding evals"
date: 2026-04-03
layout: brief-post
...
brief_data:
  ...
  summary_right:
    ...
    - label: "总结 + 观点"
      text: "OpenAI engineering 列表显示，Responses API agent comp…｜中文观点：From model to agent: Equipping the Responses…"
    - label: "总结 + 观点"
