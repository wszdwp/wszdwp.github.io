...
brief_data:
  summary_left:
    - label: "Hacker News Frontpage"
      text: "Xilem – An experimental Rust native UI framework"
    - label: "AWS Machine Learning Blog"
      text: "With Amazon Bedrock Projects, you can attribute inference costs to specific workloads an…"
    - label: "Hacker News Frontpage"
      text: "US and Iran agree to provisional ceasefire"
  ...
  summary_right:
    - label: "观点摘要"
      text: "读后看，这件事的价值在于：Anthropic didn't release their latest model, Claude Mythos ( system card PDF ), tod…"
    - label: "观点摘要"
