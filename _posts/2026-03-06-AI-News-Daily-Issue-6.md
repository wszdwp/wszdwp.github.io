...
brief_data:
  ...
  items:
    - title: "Gemma 4 and what makes an open model succeed"
      ...
      opinion: "原文重点：Hint: it's not benchmark scores. 读后观点：这篇内容真正有价值的部分是 Gemma 4 and what makes an open model succeed Hint: it's not benchmark scores."
    - title: "[AINews] Gemma 4: The best small Multimodal Open Models, dramatically better than Gemma 3 in every way"
      ...
      opinion: "原文重点：A welcome update from Google! 读后观点：这篇内容真正有价值的部分是 AINews: Weekday Roundups [AINews] Gemma 4: The best small Multimodal Open Models, dramatically better than Gemma 3 in every way A welcome update from Google!"
    ...
    - title: "Inside our approach to the Model Spec"
      ...
      opinion: "原文重点：Learn how OpenAI’s Model Spec serves as a public framework for model behavior, balancing safety, user freedom, and accountability as AI systems advance. 读后观点：这篇内容真正有价值的部分是 March 25, 2026 Research Publication Inside…"
